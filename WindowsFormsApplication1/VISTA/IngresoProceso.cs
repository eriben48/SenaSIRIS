    ...
    public partial class IngresoProceso : Form
    {
       ...
       // }
        public void Limpiar()
        {
            ...
            DateFecha.Value.Equals("");
            DateFechaRadicacion.Value.Equals("");
        ...
        private void IngresoProceso_FormClosing(object sender, FormClosingEventArgs e)
        {
           // label1.Enabled = false;
 
        }

        private void TxtConceptoNovedad_TextChanged(object sender, EventArgs e)
        {
